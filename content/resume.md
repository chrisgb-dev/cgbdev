...
description: Resume for Chris Gardiner-Bill, Developer Experience Engineer, Technical Writer
tags: Developer Experience Engineer, Technical Writer, Editor
headline: Resume
---
...
Extensive experience collaborating with engineering and DevOps teams to design **developer portals, API documentation systems, onboarding programs, and automated documentation pipelines** that scale across large organisations.

Industry experience includes **AI platforms, SaaS products, fintech, analytics, and developer tooling**.
...
Worked closely with engineering teams to design and scale **developer knowledge systems** during Canva’s transition toward AI-driven products and platforms.
...
#### Specialized Bicycle Components | 2020–2023

Responsible for establishing the organisation’s **API documentation ecosystem** and supporting engineering teams building global services.
...
#### Equifax Australia | 2014–2020

Worked across product, engineering, and client teams to design **technical documentation systems and developer training resources** for Equifax’s credit decisioning platform.
